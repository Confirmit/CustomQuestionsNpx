...
const main = async () => {
    ...
    await fs.copy(path.join(__dirname, 'templates'), cwd)
    await replaceGuidInFile(path.join(cwd, 'runtime', 'component.js'), metadata.id)

    console.log('Done. You can modify custom question files and upload it as a zip file to Confirmit.')
};
